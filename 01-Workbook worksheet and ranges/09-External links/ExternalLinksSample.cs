...
namespace EPPlusSamples.WorkbookWorksheetAndRanges
{
    ...
    public static class ExternalLinksSample
    {
        public static void Run()
        {
            ...
            var sampleFile1 = FileUtil.GetCleanFileInfo("1.09-ExternalLinks-1.xlsx");
        ...
        {
            var externalFile = FileUtil.GetFileInfo("Workbooks", "1.09-WorkbookWithExternalLinks.xlsx");
        ...
        private static void AddWorksheetWithExternalReferences(ExcelPackage p)
        {
            ...
            var externalLinkFile = FileUtil.GetFileInfo("Workbooks", "Tables.xlsx");
        ...
        {
            var externalLinkFile = FileUtil.GetFileInfo("1.01-GettingStarted.xlsx");
            var externalWorkbook = p.Workbook.ExternalLinks.AddExternalWorkbook(externalLinkFile);
        ...
        private static void BreakLinks(FileInfo sampleFile1)
        {
            ...
            using(var p=new ExcelPackage(sampleFile1))
            {
                ...
                var newFile = FileUtil.GetFileInfo("1.09-ExternalLinks-Link1Removed.xlsx");
                p.SaveAs(newFile);
            }
        }
