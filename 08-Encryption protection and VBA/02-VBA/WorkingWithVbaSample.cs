...
{
    public static class WorkingWithVbaSample
    {
        ...
        private static void SimpleVba()
        {
            ...
            //And Save as xlsm
            FileInfo fi = FileUtil.GetCleanFileInfo("8.2-01-SimpleVba.xlsm");
            pck.SaveAs(fi);
        }
        private static void AddABubbleChart()
        {
            ...
            //And Save as xlsm
            FileInfo fi =FileUtil.GetCleanFileInfo("8.2-02-AddABubbleChartVba.xlsm");
            pck.SaveAs(fi);
        }
        private static void CreateABattleShipsGame()
        {
            ...
            pck.Workbook.VbaProject.Protection.SetPassword("EPPlus");
             ...
             var codeDir = FileUtil.GetSubDirectory("08-Encryption Protection and VBA\\02-VBA", "VBA-Code");
            ...
            var fi = FileUtil.GetCleanFileInfo(@"8.2-03-CreateABattleShipsGameVba.xlsm");
            pck.SaveAs(fi);
        }
