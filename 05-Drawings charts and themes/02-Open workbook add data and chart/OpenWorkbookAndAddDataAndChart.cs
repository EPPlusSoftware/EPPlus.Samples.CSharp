...
namespace EPPlusSamples.DrawingsChartsAndThemes
{
    public class OpenWorkbookAndAddDataAndChartSample
    {
        ...
        public static void Run()
        {
            ...
            FileInfo newFile = FileUtil.GetCleanFileInfo("5.2-OpenWorkbookAndAddDataAndChartSample.xlsx");
            FileInfo templateFile = FileUtil.GetFileInfo("Workbooks", "5.2-ExistingWorkbook.xlsx");
            ...
            using (ExcelPackage package = new ExcelPackage(newFile, templateFile))
            {
                ...
                var ser = chart.Series.Add(valueAddress.Address, "B2:B6");
