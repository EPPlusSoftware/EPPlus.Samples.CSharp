...
namespace EPPlusSamples.DrawingsChartsAndThemes
{
    public static class ShapesAndImagesSample
    {
        public static void Run()
        {
            ...
            //The output package
            var outputFile = FileUtil.GetCleanFileInfo("5.1-ShapesAndImages.xlsx");
        ...
        private static void PictureSample(ExcelPackage package)
        {
            ...
            var pic = ws.Drawings.AddPicture("Landscape", FileUtil.GetFileInfo("05-Drawings charts and themes\\01-Shapes and images", "LandscapeView.jpg"));
