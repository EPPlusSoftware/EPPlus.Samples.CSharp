...
namespace EPPlusSamples.FiltersAndValidations
{
    public class Filter
    {
        ...
        private static async Task ValueFilter(ExcelPackage p)
        {
            var ws = p.Workbook.Worksheets.Add("ValueFilter");
            ExcelRangeBase range = await LoadFromDatabase(ws);
        ...
        private static async Task DateTimeFilter(ExcelPackage p)
        {
        ...
        private static async Task CustomFilter(ExcelPackage p)
        {
        ...
        private static async Task Top10Filter(ExcelPackage p)
        {
        ...
        private static async Task DynamicAboveAverageFilter(ExcelPackage p)
        {
        ...
        private static async Task DynamicDateAugustFilter(ExcelPackage p)
        {
        ...
        private static async Task TableFilter(ExcelPackage p)
        {
        ...
        private static async Task PivotTableFilter(ExcelPackage p)
        {
        ...
        private static async Task<ExcelRangeBase> LoadFromDatabase(ExcelWorksheet ws)
        {
