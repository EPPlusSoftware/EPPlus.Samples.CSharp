...
namespace EPPlusSamples.FormulaCalculation
{
    ...
    /// </summary>
    public static class CalculateExistingWorkbook
    {
        ...
        public static void Run()
        {
            ...
            var filePath = FileUtil.GetFileInfo("06-Formula calculation\\01-Formula calculation", "FormulaCalcSample.xlsx").FullName;
